...
package com.vfs.fingerprint.anylinemrz.mrz;
...
import com.vfs.fingerprint.anylinemrz.ScanActivity;
...
public class ScanMrzActivity extends ScanActivity implements CameraOpenListener, AnylineDebugListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "onCreate: called ak check scan mrz:");
	...
	void init() {
		...
		//init the scan view
		Log.d(TAG, "onCreate: called ak check scan mrz:2");
		...
		Log.d(TAG, "onCreate: called ak check scan mrz:3");
