...
import kotlinx.android.synthetic.main.activity_page_preview.action_filter
...
class PageFiltersActivity : AppCompatActivity(), FiltersListener, CoroutineScope {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        action_crop_and_rotate.setOnClickListener {
            ...
            croppingConfig.setBottomBarButtonsColor(ContextCompat.getColor(this, R.color.goldColor))
            croppingConfig.setTopBarButtonsColor(ContextCompat.getColor(this, R.color.goldColor))
