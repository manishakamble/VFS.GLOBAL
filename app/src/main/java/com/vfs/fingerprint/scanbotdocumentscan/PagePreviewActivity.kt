...
class PagePreviewActivity : AppCompatActivity(), FiltersListener, SaveListener, CoroutineScope {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("adapters","check called ak items:"+PageRepository.getPages().size)
        ...
        findViewById<View>(R.id.action_add_page).setOnClickListener {
            ...
            cameraConfiguration.setBottomBarButtonsColor(ContextCompat.getColor(this, R.color.goldColor))
    ...
    private inner class PagesAdapter : RecyclerView.Adapter<PageViewHolder>() {
        ...
        override fun getItemCount(): Int {
            Log.d("TAG","called ak check count size:"+items.size)
            return items.size
        }
    }
